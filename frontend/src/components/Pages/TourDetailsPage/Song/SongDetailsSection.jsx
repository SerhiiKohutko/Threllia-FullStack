        ...
        <div className="flex flex-col min-h-screen bg-black text-white">
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
                    ...
                    <div className="border border-orange-900 bg-black p-6">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <Button variant="outline" className="w-full bg-transparent border-orange-800 text-white hover:bg-orange-900 mb-2 flex items-center justify-center gap-2">
                                <Play size={18} />
                                <span>PLAY SONG</span>
                            </Button>
                        </div>
                ...
                <div className="border border-orange-900 bg-black p-6">
                    <h2 className="text-4xl font-bold mb-6 text-center">APPEARED ON THESE RELEASES</h2>
                    <div className="flex flex-col items-center">
                        <div>
                            <img
                                ...
                                alt="Live Album"
                                className="w-[50%] h-auto border border-gray-800"
                            />
                        </div>
                    </div>
                </div>
