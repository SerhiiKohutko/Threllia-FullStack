...
const ShowDetailsEditAdmin = () => {
    ...
    const handleMoveSongUp = (index) => {
        if (index === 0) return;
        const newList = [...updatedSongsList];
        const temp = newList[index];
        newList[index] = newList[index - 1];
        newList[index - 1] = temp;
        setUpdatedSongsList(newList);
    };

    const handleMoveSongDown = (index) => {
        if (index === updatedSongsList.length - 1) return;
        const newList = [...updatedSongsList];
        const temp = newList[index];
        newList[index] = newList[index + 1];
        newList[index + 1] = temp;
            ...
            <div className="container mx-auto px-4 py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
                    ...
                    <div className="space-y-10">
                        {/* Setlist */}
                        <div className="bg-gray-900 p-6 border border-gray-800">
                            <h2 className="text-2xl font-bold mb-4 text-orange-500">SETLIST</h2>
                                    ...
                                    <div key={index} className="flex items-center justify-between bg-gray-800 p-3 border-l-2 border-orange-500">
                                        ...
                                        <div className="flex space-x-2">
                                            ...
                                            <button
                                                ...
                                                className="text-blue-500 hover:text-blue-400 px-2"
                                                disabled={index === updatedSongsList.length - 1}>
                                                ↓
                                            </button>
                                            <button
