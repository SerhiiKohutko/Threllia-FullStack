                    ...
                    <div className={"w-[70%] border-orange-500 border-b justify-items-start space-y-10 py-10 mb-5"}>
                        {
                            news.news?.map((latestUpdate, index) => (
                                index % 2 !== 0 ?
                                    <div className={"w-full flex flex-row"} key={latestUpdate.id}>
                                        <div className={"text-white w-[50%] flex flex-col items-end pr-8"}>
                                            <div
                                                className="text-amber-500 text-xl mb-2 text-right">{getFormattedDate(latestUpdate.dateCreated)}</div>
                                    ...
                                    <div className={"w-full flex flex-row"} key={latestUpdate.id}>
                                        ...
                                        <div className={"text-white w-[50%] pl-8"}>
                                            <div
                                                className="text-amber-500 text-xl mb-2">{getFormattedDate(latestUpdate.dateCreated)}</div>
